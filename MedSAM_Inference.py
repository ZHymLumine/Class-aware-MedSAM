...
parser = argparse.ArgumentParser(description='run inference on testing set based on Class-aware-MedSAM')
...
parser.add_argument('-chk', '--checkpoint', type=str, default='work_dir/Class-aware-MedSAM/medsam_vit_b.pth', help='path to the trained model')
...
ax[1].set_title("Class-aware-MedSAM Segmentation")
plt.show()
